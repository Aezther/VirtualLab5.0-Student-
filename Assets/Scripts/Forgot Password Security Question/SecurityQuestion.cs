        ...
        using (IDbConnection dbConnection = new SqliteConnection(connectionString)) {
            ...
            using (IDbCommand dbCmd = dbConnection.CreateCommand()) {
                ...
                if( (!string.IsNullOrEmpty(IFSecurityQuestion.text)&& !string.IsNullOrWhiteSpace(IFSecurityQuestion.text.Trim())) && 
                    ...
                    //sqlQuery = "INSERT INTO SecurityQuestionsTeachersTBL (Question, Answer, TeacherID) VALUES ('"+IFSecurityQuestion.text+"', '"+IFAnswer.text+"', '"+userInfo.StudentID+"')";
                    sqlQuery = "INSERT INTO SecurityQuestionsStudentsTBL (Question, Answer, StudentID) VALUES ('"+IFSecurityQuestion.text+"','"+IFAnswer.text+"','"+userInfo.StudentID+"')";
